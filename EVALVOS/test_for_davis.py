...
mask_data_root = "/workdir/AMCNet/datasets/DAVIS/Annotations/480p_2016"
...
def eval_method_from_data(
    ...
    eval_video_name_list = get_eval_video_name_list(data_info_dict)
