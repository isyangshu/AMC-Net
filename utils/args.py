...
def get_parser():
    parser = argparse.ArgumentParser(description='AMCNet')

    parser.add_argument('-imsize', dest='imsize', default=384, type=int)
    ...
    parser.add_argument('-seed', dest='seed', default=2018, type=int)
    parser.add_argument('-gpu_id', dest='gpu_id', default=0, type=int)
    parser.add_argument('-lr', dest='lr', default=1e-3, type=float)
    parser.add_argument('-lr_decay', dest='lr_decay', default=0.9, type=float)
