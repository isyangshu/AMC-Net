...
class Decoder(nn.Module):
    ...
    def forward(self, r5, r4, r3, r2):
        ...
        p2_up = F.interpolate(p2, size=(473, 473), mode='bilinear',  align_corners=True)
        p3_up = F.interpolate(p3, size=(473, 473), mode='bilinear',  align_corners=True)
        p4_up = F.interpolate(p4, size=(473, 473), mode='bilinear',  align_corners=True)
        p5_up = F.interpolate(p5, size=(473, 473), mode='bilinear',  align_corners=True)
...
class Refine(nn.Module):
    ...
    def forward(self, f, pm):
        ...
        m = s + F.interpolate(pm, size=s.shape[2:4], mode='bilinear',  align_corners=True)
